...
const MyGroups = ({ searchTerm, showSearch, onSearchToggle }) => {
  ...
  const renderHeaderContent = () => {
    if (showNotification || showCreateGroup || showSearch) {
      return (
        <motion.button
  ...
  return (
    <Card title="My Groups" headerContent={renderHeaderContent()}>
      ...
      <AnimatePresence mode="wait">
        {showNotification ? (
          ...
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            exit={{ opacity: 0, y: -20 }}
            className="font-poppins text-[14px] flex flex-col justify-center items-center gap-2.5"
          >
            <div>
